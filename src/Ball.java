...
public class Ball {
    ...
    */
   public void update(float time, ArrayList<Ball> balls, int i) {
      ...
      if (earliestCollisionResponse.t <= time) { // FIXME: threshold?
         // This ball collided, get the new position and speed
    	  ...
    	  if(!this.getColor().equals(Color.BLACK) && !this.getColor().equals(Color.RED)){
    		  if(this.distance>0){
         ...
         this.distance-= this.speedX - this.speedY;
    		  }
    	  }
      } else {
